 ...
 */
public class SearchReserveNowActivity extends Activity implements View.OnClickListener {
                ...
                case CommunalInterfaces.HOME_RESERVE_ROOM:
                    ...
                    try {
                        ...
                        if (status.equals("success")) {
                            ...
                            homePageReserveAdapter = new HomePageReserveAdapter(SearchReserveNowActivity.this, arrayList,
...
//        intent.getStringExtra("roomId");
        if (NetUtil.isConnnected(this)) {
            new HomepageRequest(this, handler).searchReserveRoom(searchName);
        }
        Log.e("执行", "");
//        onItemClick();
    }
